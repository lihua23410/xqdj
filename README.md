...
| `面灵气` | 150 | 9999 | 最大生命 75。球色自己渐变，不改别人颜色。开局给自己和敌人各一个派系图标（青/红/紫/苍）。撞墙（不是撞人）时随机换成另一个。对异派系伤害 +15%，受同派系伤害 −15%。自身：红挂 150° 扇环弹伤 8、紫回血（每秒 1）、青射弹（速 170、伤 5、弹 2）、苍把速度顶到 250（同时只生效当前派系）。凑齐四种后朝四周打出青/红/紫/苍四发弹幕（速 300、伤 7、弹 4） |
...
| `优昙华院` | 152 | 9999 | 灵力上限 5，撞墙 +1.2。空灵力挨打 ×1.5；前方命中可耗灵力减到 75%。5 槽手牌。技能：三发散射索敌弹伤 4；心弹加速飞出撞墙裂 8 碎弹；贴身断空伤 12 击退 300；激光前摇 0.4s 后 0.5s 宽 24 伤 2/0.2s；分身连射 5 发幻弹伤 3；毒烟 10s 伤 1/0.5s 并把敌巡航压到约 40%；花冠长大到 r≤60 伤 18；服药叠攻防，第 4 次爆 r=168 伤 40 |
...
非可选单位（不进选人列表，`Fighter: false`）：`子弹`、`分身`、`分身弧`、`无下限`、`无下限术士弧`、`无下限弧`、`紫弹`、`青弹`、`面具青`、`面具红`、`面具紫`、`面具苍`、`面灵气弧`、`盾`、`盾碎片`、`弱化碎片`、`地慧星残影`、`地慧星斩击`、`地慧星弧`、`地慧星弹`、`原型机_近战弧`、`小骑士弧`、`收割者镰刀`、`收割者收回镰刀`、`钓鱼佬鱼塘`、`钓鱼佬场鱼塘`、`钓鱼佬鱼`、`钓鱼佬中鱼`、`钓鱼佬大鱼`、`囚徒钩爪`、`囚徒囚笼`、`囚徒绞刑架`、`囚徒电椅`、`狼人月亮`、`狼人弧`、`狼人撕咬弧`、`优昙华院心弹`、`优昙华院碎弹`、`优昙华院分身`、`优昙华院幻弹`、`优昙华院花冠`、`优昙华院激光`、`优昙华院毒烟`、`优昙华院索敌弹`、`优昙华院爆药`。
...
5. **`window.lookFX` 的短名是全局的**，不按包隔离。不要和别的球撞。现在已占用：`glitch`、`glitch-still`、`slash`、`crescent`、`chroma`、`pull`、`push`、`bond`、`engine`、`radar`、`reaper`、`sickle`、`prisoner`、`cage`、`gallows`、`chair`、`fisher`、`fisher-pond`、`fisher-flood`、`fisher-fish`、`wolf`、`moon`、`udongein`、`udongein-ghost`、`udongein-mind`、`udongein-shard`、`udongein-crown`、`udongein-gas`、`udongein-seek`、`udongein-blast`、`udongein-beam`。一次性特效的名字按包隔离，皮肤短名不会。
