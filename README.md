...
| `吹笛人` | 165 | 9999 | 本体不出伤。每 2.5s 吹笛：站定 0.4s、从球边放出一只老鼠，场上最多 6 只。老鼠 r=9、8 血、速 260、视野 9999。默认去贴最近可命中敌人（停在球面外 16，不咬）；看见「东西」就去偷——敌方战斗机、活随从、攻击环之外的弹/面具/鱼塘/月亮/残影/刑具/分身等，叼着降到 180 跑回，本体 40 内入洞回 3 血。老鼠死亡，或活老鼠跟在敌人身边（球面外 100 内）连续满 5s（中途离开清零）：叠【瘟疫】，当帧按叠完后层数扣血，之后每 3s 再跳。叼东西的老鼠被打死则东西掉回原处。常驻 `Pass`。墙偷不走 |
