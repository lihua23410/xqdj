...
| `内燃机` | 120→300 | 96→216 | 撞墙升档（1–6，无冷却）。档位拉巡航、视野、普通攻击。普通攻击是自己的 0.5s 节拍，就绪就跳，没人也进 CD；1–2 档 0、3–4 档 1、5 档 2、6 档 3。弱点值按确认掉血加，上限 60…10。击破后虚弱 2s（速度 0、普通攻击不扣血、档位外观保持变暗），1s 时按该档视野打击破伤害 5…30，2s 回 1 档并沿击破前朝向以 120 起步 |
